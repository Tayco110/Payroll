...
public class Commissioned extends Employee
{
    ...
    public Commissioned(String name,String address,String type,String paymentmethod,String schedule,int id,int sindicate_id,int is_sindicate,double union_fee,double salaray,double commission)
    {
